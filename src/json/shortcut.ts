			...
			children: [
...

				{
					name: translate('popupShortcutNavigation'), children: [
						...
						{ id: 'space1', name: U.String.sprintf(translate('popupShortcutMainBasics27'), 1), keys: [ cmdKey, '1' ] },
						{ id: 'space2', name: U.String.sprintf(translate('popupShortcutMainBasics27'), 2), keys: [ cmdKey, '2' ] },
						{ id: 'space3', name: U.String.sprintf(translate('popupShortcutMainBasics27'), 3), keys: [ cmdKey, '3' ] },
						{ id: 'space4', name: U.String.sprintf(translate('popupShortcutMainBasics27'), 4), keys: [ cmdKey, '4' ] },
						{ id: 'space5', name: U.String.sprintf(translate('popupShortcutMainBasics27'), 5), keys: [ cmdKey, '5' ] },
						{ id: 'space6', name: U.String.sprintf(translate('popupShortcutMainBasics27'), 6), keys: [ cmdKey, '6' ] },
						{ id: 'space7', name: U.String.sprintf(translate('popupShortcutMainBasics27'), 7), keys: [ cmdKey, '7' ] },
						{ id: 'space8', name: U.String.sprintf(translate('popupShortcutMainBasics27'), 8), keys: [ cmdKey, '8' ] },
						{ id: 'space9', name: U.String.sprintf(translate('popupShortcutMainBasics27'), 9), keys: [ cmdKey, '9' ] },
				...
				{ 
					name: translate('popupShortcutEditor'), children: [
						...
						{ id: 'turnBlock2', name: translate('popupShortcutEditorTurn2'), keys: [ cmdKey, 'alt', '2' ] },
						{ id: 'turnBlock3', name: translate('popupShortcutEditorTurn3'), keys: [ cmdKey, 'alt', '3' ] },
						{ id: 'turnBlock4', name: translate('popupShortcutEditorTurn4'), keys: [ cmdKey, 'alt', '4' ] },
						{ id: 'turnBlock5', name: translate('popupShortcutEditorTurn5'), keys: [ cmdKey, 'alt', '5' ] },
						{ id: 'turnBlock6', name: translate('popupShortcutEditorTurn6'), keys: [ cmdKey, 'alt', '6' ] },
						{ id: 'turnBlock7', name: translate('popupShortcutEditorTurn7'), keys: [ cmdKey, 'alt', '7' ] },
						{ id: 'turnBlock8', name: translate('popupShortcutEditorTurn8'), keys: [ cmdKey, 'alt', '8' ] },
						{ id: 'turnBlock9', name: translate('popupShortcutEditorTurn9'), keys: [ cmdKey, 'alt', '9' ] },
					]
				},
			...
			children: [
				{
					...
					children: [
						...
						{ name: U.String.sprintf(translate('popupShortcutMarkdownWhileTypingInserts'), '⟶'), text: '-->' },
						{ name: U.String.sprintf(translate('popupShortcutMarkdownWhileTypingInserts'), '⟵'), text: '<--' },
						{ name: U.String.sprintf(translate('popupShortcutMarkdownWhileTypingInserts'), '⟷'), text: '<-->' },
						{ name: U.String.sprintf(translate('popupShortcutMarkdownWhileTypingInserts'), '→'), text: '->' },
						{ name: U.String.sprintf(translate('popupShortcutMarkdownWhileTypingInserts'), '←'), text: '<-' },
						{ name: U.String.sprintf(translate('popupShortcutMarkdownWhileTypingInserts'), '—'), text: '--' },
						{ name: U.String.sprintf(translate('popupShortcutMarkdownWhileTypingInserts'), '®'), text: '(r)' },
						{ name: U.String.sprintf(translate('popupShortcutMarkdownWhileTypingInserts'), '™'), text: '(tm)' },
						{ name: U.String.sprintf(translate('popupShortcutMarkdownWhileTypingInserts'), '…'), text: '...' },
					]
				},
				{
					...
					children: [
						...
						{ name: translate('popupShortcutMarkdownBeginningOfLine7'), text: U.String.sprintf(translate('popupShortcutMarkdownBeginningOfLineKey'), '1.') },
						{ name: translate('popupShortcutMarkdownBeginningOfLine8'), text: U.String.sprintf(translate('popupShortcutMarkdownBeginningOfLineKey'), '>') },
						{ name: translate('popupShortcutMarkdownBeginningOfLine9'), text: U.String.sprintf(translate('popupShortcutMarkdownBeginningOfLineKey'), '```') },
						{ name: translate('popupShortcutMarkdownBeginningOfLine10'), text: U.String.sprintf(translate('popupShortcutMarkdownBeginningOfLineKey'), '---') },
						{ name: translate('popupShortcutMarkdownBeginningOfLine11'), text: U.String.sprintf(translate('popupShortcutMarkdownBeginningOfLineKey'), '***') },
					]
				},
			]
		},
